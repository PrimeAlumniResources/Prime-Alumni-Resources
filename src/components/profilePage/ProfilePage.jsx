  ...
  return (
    ...
    <div className=" bg-gray-50 shadow-md shadow-emerald-100 text-base pt-10 sm:text-5 md:text-md lg:text-md ">
      ...
      >
        ...
        <div class="shadow-2xl opacity-90 shadow-emerald-100  mt-16 flex flex-col items-center pb-10 flex p-4 mt-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-white dark:text-green-400">
          ...
          <h2 class="ml-10 mt-4 text-lg">{profile.first_name} {profile.last_name}</h2>
          <h4 class="mt-2 ml-12  ">Visual Designer</h4>
        ...
        <div className=" md:flex-row  justify-evenly w-fit h-fit flex -mt-12">
          ...
          <div className="ml-10  inline">
            ...
            <h3 className="flex text-emerald-400 rounded-lg bg-white   flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row " >{profile.username}</h3> <br />
            ...
            <a
              ...
              className="flex text-emerald-400 rounded-lg bg-white  flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row  "
            >
              {profile.linked_in}
            </a>
          ...
          <div className=" border-solid border-black  -mt-3 ml-6 border-solid border-black">
            ...
            <h3 className="flex text-emerald-400 rounded-lg bg-white  flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row ">{profile.current_work}</h3>
            <label className="block mt-4 text-sm font-medium text-gray-900 dark:text-black">
              Position:
            </label>
            <h3 className="flex text-emerald-400 rounded-lg bg-white  flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row ">{profile.position}</h3>
            <label className="block mt-4 text-sm font-medium text-gray-900 dark:text-black">
              Start Date:
            </label>
            <h3 className="flex text-emerald-400 rounded-lg bg-white  flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row  ">{moment(profile.start_date).format('MMMM Do, YYYY')}</h3>
          </div>
          ...
          <div className=" ml-5 inline">
            ...
            <h3 className="flex text-emerald-400 rounded-lg bg-white shadow-sm shadow-emerald-100 flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row " >{cohorts.name}</h3> <br />
            <label className="block -mt-2 text-sm font-medium text-gray-900 dark:text-black">
              Cohort Start Date:
            </label>
            <h5 className="flex text-emerald-400 rounded-lg bg-white shadow-sm shadow-emerald-100 flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row  ">{moment(cohorts.start_date).format('MMMM Do, YYYY')}</h5>
            <label className="block  mt-4 text-sm font-medium text-gray-900 dark:text-black">
              Cohort End Date:
            </label>
            <h5 className="flex text-emerald-400 rounded-lg bg-white shadow-sm shadow-emerald-100 flex items-center justify-center h-fit  flex-col w-fit p-2 rounded-lg shadow md:flex-row ">{moment(cohorts.end_date).format('MMMM Do, YYYY')}</h5>
      ...
      <div className="flex justify-evenly">
        ...
        <div>
          <h2 className="text-emerald-400 bg-white shadow-lg shadow-emerald-100 flex items-center justify-center h-fit  flex-col w-fit p-2 pl-10 pr-10  rounded-lg shadow md:flex-row mt-4">
            Current Stack
          </h2>
