...
{/* --------------------------------------PROFILE IMAGE + FIRST & LAST CONTAINER----------------------------- */}
            ...
            <a href="#" target="_blank" class=" flex h-80 ml-2 flex-col items-center w-full rounded-lg shadow md:flex-row ">
...
{/* --------------------------------------CONTAINER FOR SOCIALS + USERNAME------------------------------ */}
                ...
                <div className=" md:flex-row  justify-evenly w-fit h-fit flex -ml-40 mt-16">
                    <div className="inline">
                        <label className="block mt-4 text-sm font-medium text-gray-900 dark:text-black">Username:</label>
                        <h3>{profile.username}</h3> <br />
                        <label className="-mt-6 block text-sm font-medium text-gray-900 dark:text-black">LinkedIn</label>
                        <a target="_blank" href={profile.linked_in}class=" hover:underline">{profile.linked_in}</a> 
                        <label className="block mt-2  text-sm font-medium text-gray-900 dark:text-black">Github:</label>
                        <a target="_blank" href={profile.github} class="hover:underline">{profile.github}</a> <br />
                    </div>
{/* --------------------------------------CONTAINER FOR WORK INFO------------------------------ */}

                    <div className=" border-solid border-black  -mt-3 ml-6 border-solid border-black">
                    <label className="block mt-6  text-sm font-medium text-gray-900 dark:text-black">Current Work:</label>
...
{/* --------------------------------------CONTAINER FOR COHORT INFO + PORTFOLIO------------------------------ */}
                    ...
                    <div className="ml-7 inline">
                        <label className="block mt-2   text-sm font-medium text-gray-900 dark:text-black">Cohort:</label>
                        ...
                        <a target="_blank" href={profile.portfolio_url}class=" hover:underline">{profile.portfolio_url}</a> <br />
                    </div>
