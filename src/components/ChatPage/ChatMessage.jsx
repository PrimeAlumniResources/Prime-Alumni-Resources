...
function ChatMessage(props) {
  ...
  return (
    <div className="flex" >
      ...
      <div className="mb-4 mx-12 mt-4 ml-2 w-fit bg-green-50 border-green-500 text-emerald-400 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block p-2.5 shadow-1xl opacity-90 shadow-emerald-100 bg-white">
