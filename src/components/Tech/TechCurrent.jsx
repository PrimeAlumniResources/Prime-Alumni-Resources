...
{/* --------------------FUNCTION USED TO DELETE CURRENT TECH--------------------- */} 
    ...
    const handleDeleteCurrentPress = () => {
    ...
    return (
        ...
        <button onClick={handleDeleteCurrentPress} type="button" className="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-6 w-6 dark:bg-white dark:text-emerald-400 dark:hover:bg-white" data-dismiss-target="#alert-3" aria-label="Close">
